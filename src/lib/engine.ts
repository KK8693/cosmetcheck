...
const ANVISA_RULES: Omit<Violation, 'matchedText' | 'position'>[] = [
  ...
  },
  {
    ...
    aliases: ['对苯二酚', '氢醌', 'hidroquinona', 'hidroquinona', 'HQ', 'quinol', 'benzenediol', '1,4-benzenediol', '美白剂', 'bleaching agent'],
    source: 'ANVISA RDC 529/2021',
  },
  {
    ruleId: 'BR-ING-004',
    ...
    aliases: ['皮质类固醇', 'corticosteróide', 'corticosteroide', 'steroid', 'cortisone', 'prednisone', '氢化可的松', '类固醇激素', 'corticoides', '激素提取物', '动物激素', 'hormone extract', 'animal hormone', '雌激素', '孕激素', 'hormônio', 'extrato de hormônio', 'estrogênio', 'progesterona', 'hormona', 'extracto de hormona', 'estrógeno', 'progesterona'],
    source: 'ANVISA RDC 529/2021',
  },
  {
    ruleId: 'BR-ING-005',
  ...
  },
  {
    ...
    aliases: ['植物激素', '植物调节因子', '植物调节物', '植物生长素', '植物调控因子', '细胞分裂素', '赤霉素', '生长素', 'auxin', 'gibberellin', 'cytokinin', 'abscisic acid', 'ethylene', 'brassinolide', 'jasmonate', 'hormônio vegetal', 'hormona vegetal', 'regulador vegetal', 'fator de crescimento vegetal', 'fitohormônio', 'fitohormona', 'extrato hormonal vegetal', 'extracto hormonal vegetal', 'plant growth regulator', 'phytohormone', 'phytoregulator', 'plant regulator factor', '植物激素隐晆别名', '植物激素提取物'],
    source: 'ANVISA RDC 529/2021',
  },
  // Label/Claim rules
  {
  ...
  },
  {
    ...
    category: 'claim',
    ruleType: 'prohibited',
    keyword: 'unauthorized clinical claim',
    severity: 'critical',
    ...
    aliases: ['肌肤耐受实验', '肌肤耐受测试', '肌肤实验', '临床验证', '临床测试', '临床实验', '实验验证', '实验证明', '医学实验', '药理实验', 'teste de tolerabilidade cutânea', 'experimento clínico', 'validação clínica', 'prova clínica', 'teste dermatológico clínico', 'experimento dermatológico', 'prueba de tolerancia cutánea', 'experimento clínico', 'validación clínica', 'prueba dermatológica clínica', 'experimento dermatológico', 'clinical experiment', 'medical experiment', 'dermatological experiment', 'laboratory test', 'lab tested', 'lab verified'],
    source: 'ANVISA RDC 529/2021',
  },
  {
    ruleId: 'BR-CLM-012',
    category: 'claim',
    ruleType: 'prohibited',
    keyword: 'absolute safety promise',
    severity: 'critical',
    ...
    aliases: ['零排斥反应', '零排斥', '百分百适配', '所有肤质适用', '所有肤质百分百适配', '零过敏', '零刺激', '100%安全', '绝对安全', '完全无刺激', '完全不致敏', '适用于所有肌肤', '适合一切肤质', '一切肤质均适用', '百分百无敏感', '无任何副作用', '完全无毒', '完全无害', 'sem rejeição', 'zero rejeição', '100% compatível', 'para todos os tipos de pele', 'zero alergia', '100% seguro', 'totalmente seguro', 'completamente seguro', 'sem nenhum efeito colateral', 'sem risco', 'cero rechazo', 'sin rechazo', '100% compatible', 'para todo tipo de piel', 'cero alergia', '100% seguro', 'totalmente seguro', 'completamente seguro', 'sin ningún efecto secundario', 'sin riesgo', 'zero side effects', '100% safe', 'completely safe', 'totally safe', 'no risk', 'suitable for all skin types', 'for all skin types', 'all skin types compatible'],
    source: 'ANVISA IN 26/2022',
  },
  {
    ruleId: 'BR-CLM-013',
    category: 'claim',
    ruleType: 'prohibited',
    keyword: 'physiological mechanism claim',
    severity: 'critical',
    ...
    aliases: ['稳定肌肤色素代谢机制', '稳定色素代谢', '调理色素', '干预代谢', '改善机能', '色素代谢机制', '肌肤代谢机制', '代谢机制', '调节机制', '干预机制', '调控机制', '修复机能', '激活机能', '促进代谢', '加快代谢', '调节生理功能', '干预生理过程', 'estabilizar o mecanismo metabólico', 'regulação do metabolismo de melanina', 'mecanismo de pigmentação', 'intervir no metabolismo', 'regular a melanina', 'mecanismo metabólico', 'função fisiológica', 'regulação fisiológica', 'estabilizar el metabolismo de melanina', 'regulación del metabolismo de melanina', 'mecanismo de pigmentación', 'intervenir el metabolismo', 'regular la melanina', 'metabolismo cutáneo', 'función fisiológica', 'regulación fisiológica', 'melanin metabolism', 'pigment metabolism', 'regulate melanin', 'melanin regulation', 'stabilize metabolism', 'metabolic mechanism', 'physiological function', 'intervene metabolism', 'improve physiological function'],
    source: 'ANVISA RDC 529/2021',
  },
