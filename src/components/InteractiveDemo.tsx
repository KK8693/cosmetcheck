...
export function InteractiveDemo() {
  ...
  const regulator = country === 'BR' ? 'ANVISA' : 'COFEPRIS'
            ...
            <div className="p-6 font-mono text-sm min-h-[280px]">
              {step === 'idle' && (
                <div className="text-gray-400 text-center py-12">
                  <p className="text-lg">{t('clickToStart')}</p>
                </div>
              )}
              ...
              {step === 'scanning' && (
                <div className="space-y-2">
                  ...
                  <p className="text-[#00A86B] animate-pulse">▋ {t('scanning')}</p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-red-900/20 rounded-lg p-3 border border-red-800/50">
                    <p className="text-red-400">
                      ...
                      <span className="text-red-400 ml-2">⚠️ {t('bannedIngredient')}</span>
                    </p>
                    <p className="text-red-400/70 text-xs mt-2">
                      {country === 'BR' ? t('regulationBR') : t('regulationMX')}
                    </p>
                  </div>
                </div>
              )}
              ...
              {step === 'fixed' && (
                <div className="space-y-3">
                  ...
                  <p className="text-[#00A86B]">✓ {t('scanComplete')}</p>
                  <hr className="border-gray-700" />
                  <p className="text-yellow-400">{t('autoReplace')}</p>
                  ...
                  <p className="text-[#00A86B] font-bold">{t('aiGenerated')}</p>
