...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Mexico COFEPRIS Cosmetics Regulation 2025: Complete Guide for Sellers | CosmetCheck',
    description: 'Complete guide to Mexico COFEPRIS cosmetics compliance for sellers. Banned ingredients, labeling requirements, import process, platform rules (Amazon MX, Mercado Libre, Liverpool), and penalties.',
    keywords: 'COFEPRIS cosmetics regulation, Mexico cosmetic compliance, COFEPRIS banned ingredients, Mercado Libre cosmetics, Amazon Mexico beauty products',
    openGraph: {
      title: 'Mexico COFEPRIS Cosmetics Compliance Guide | CosmetCheck',
      description: 'The complete seller\'s guide to Mexico cosmetic regulations.',
      type: 'article',
    },
    alternates: {
      canonical: 'https://cosmetcheck.com/regulation/mexico',
    },
  }
}
...
export default function MexicoRegulationPage() {
  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: 'Mexico COFEPRIS Cosmetics Regulation 2025: Complete Guide for Sellers',
    description: 'Complete guide to Mexico COFEPRIS cosmetics compliance for international sellers.',
        ...
        <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <div className="text-sm text-amber-400 font-medium">COFEPRIS Regulation Guide</div>
                <h1 className="text-3xl sm:text-4xl font-bold">
                  Mexico Cosmetics Compliance
                </h1>
              </div>
            </div>
            <p className="text-lg text-slate-400 max-w-2xl">
              Everything you need to know to sell cosmetics in Mexico legally. Banned ingredients,
              ...
              <div className="grid sm:grid-cols-2 gap-2">
                {sections.map((s) => (
                  <a
                    key={s.id}
                    href={`#${s.id}`}
                    className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-[#0F1419] text-sm text-slate-300 hover:text-amber-400 transition-colors"
                  >
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#1A1F26] rounded-2xl border border-[#2A3038] p-6 sm:p-8">
              ...
              <div className="prose prose-invert max-w-none">
                {/* TODO: 运营填充 - COFEPRIS核心法规概述 */}
                <p className="text-slate-400">
                  <span className="inline-block px-2 py-1 rounded bg-amber-500/10 text-amber-400 text-xs font-medium mr-2">
                    TODO
                  </span>
                  运营补充：COFEPRIS 核心法规框架（NOM-141-SSA1 等）、化妆品定义与分类、
                  适用范围、与美国 FDA 和加拿大 Health Canada 的关键差异。
                </p>
                <ul className="space-y-2 text-slate-400 mt-4">
                  <li>• <strong>NOM-141-SSA1</strong> — TODO: 一句话说明</li>
                  <li>• <strong>NOM-240-SSA1</strong> — TODO: 一句话说明</li>
                  <li>• <strong>COFEPRIS Cosmetics Sanitary Registry</strong> — TODO: 一句话说明</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#1A1F26] rounded-2xl border border-[#2A3038] p-6 sm:p-8">
              ...
              <p className="text-slate-400 mb-4">
                ...
                运营补充：墨西禁用成分的主要类别（美白类、激素类、重金属类等）、
                常见高危成分清单、与美国卖家常用成分的冲突点。
              </p>
              <Link
                href="/ingredients?country=mexico&status=banned"
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#1A1F26] rounded-2xl border border-[#2A3038] p-6 sm:p-8">
              ...
              <p className="text-slate-400">
                ...
                运营补充：墨西化妆品标签强制要素（西班牙语标注、INCI成分名、净含量、
                生产商信息、COFEPRIS 注册号、批号、NOM 标准符号等）、禁止使用的宣传用语。
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#1A1F26] rounded-2xl border border-[#2A3038] p-6 sm:p-8">
              ...
              <p className="text-slate-400">
                ...
                运营补充：化妆品进口墨西的流程（COFEPRIS 卫生注册号申请、
                海关清单、SAT 税务编码、必要文件清单、检验检疫要求）。
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#1A1F26] rounded-2xl border border-[#2A3038] p-6 sm:p-8">
              ...
              <p className="text-slate-400">
                ...
                运营补充：Amazon MX、Mercado Libre、Liverpool、Coppel 等主流平台
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#1A1F26] rounded-2xl border border-[#2A3038] p-6 sm:p-8">
              ...
              <p className="text-slate-400">
                ...
                运营补充：违规处罚标准（COFEPRIS 行政处罚、产品下架、刑事风险）、
                近年典型执法案例、海关扣押常见原因。
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#1A1F26] rounded-2xl border border-[#2A3038] p-6 sm:p-8">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                />
                <ResourceCard
                  title="Product Label Template (ES)"
                  description="COFEPRIS-compliant label format in Spanish"
                  href="#"
                  icon={Download}
                />
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-[#0A4D8C]/20 to-[#00A86B]/10 border border-[#0A4D8C]/30 rounded-2xl p-8 sm:p-12 text-center">
              ...
              <p className="text-slate-400 max-w-lg mx-auto mb-6">
                Our AI scans your formula against all active COFEPRIS regulations in real time.
                Get instant compliance reports for Mexico.
              </p>
              <Link href="/">
...
function ResourceCard({
  ...
  return (
    ...
    >
      ...
      <ExternalLink className="w-3.5 h-3.5 text-slate-600 group-hover:text-amber-400 transition-colors ml-auto shrink-0" />
    </a>
  )
}
