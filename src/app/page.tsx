            ...
            <Card className="border-2 border-[#7c3aed] relative overflow-hidden bg-gradient-to-b from-[#7c3aed]/5 to-white">
              ...
              <CardContent className="p-8">
                ...
                <SubscribeButton
                  ...
                  className="w-full bg-gradient-to-r from-[#fbbf24] to-[#f59e0b] text-gray-900 hover:from-[#f59e0b] hover:to-[#d97706] font-bold shadow-lg shadow-amber-500/25 animate-pulse-subtle"
                >
                  解锁无限次 — $29/月
                </SubscribeButton>
              </CardContent>
