      ...
      <div className="container-custom max-w-3xl py-20">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside text-gray-600 mb-4 space-y-1">
              <li>We do not use your product information to train AI models</li>
              <li>AI outputs are generated by us based on your input</li>
              <li>You retain full ownership of the information you input</li>
